...
- **Setting up a Spring Boot CRUD application**. With the help of [Chad Darby's Spring Boot course on Udemy](https://www.udemy.com/course/spring-hibernate-tutorial/?couponCode=KEEPLEARNING), I learned how to connect to a MySQL database, create and configure entity classes and Data Access Objects, and implement JPA CRUD operations.
